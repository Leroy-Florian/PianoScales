...
import {difficulty_description} from '../../constants/strings';
import {gameModeSetting} from '../../domain/models/settings';

interface Props {
  gameMode: gameModeSetting;
  setGameMode: React.Dispatch<React.SetStateAction<gameModeSetting>>;
}
...
export const DifficultyCard = ({
  ...
  return (
    ...
    >
      ...
      <h6 className="mt-2 font-bold">{gameMode.title}</h6>

      <p className="hidden sm:mt-1 sm:text-sm sm:text-gray-600 sm:block">
        {difficulty_description(gameMode)}
      </p>
    </a>
  );
};
